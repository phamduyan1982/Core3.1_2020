...
namespace eShopSolutionBackendApi.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        //http://localhost:port/product?pageIndex=1&pageSize=10
        [HttpGet("{languageId}")]  // alias  public_paging/
        public async Task<IActionResult> GetAllPaging(string languageId,[FromQuery] GetPublicProductPagingRequest request)
        {
            var product = await _pubicProductService.GetAllByCategoryId(languageId,request);
            return Ok(product);
        }
